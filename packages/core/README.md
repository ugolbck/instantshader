...
| `wisp` | Molten threads on a dark ground: contours of one stretched, warped noise field drawn as luminous curves that swell and thin, with white-hot cores, coloured glow and beads. | `scale`, `width`, `stretch`, `angle`, `warp`, `glow`, `sparks`, `grain` |
